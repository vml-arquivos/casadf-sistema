...
export default function About() {
  ...
  return (
    <>
      <Helmet>
        <title>Quem Somos - CasaDF Imóveis | Corretor de Imóveis de Luxo em Brasília</title>
        <meta 
          name="description" 
          content="Conheça CasaDF Imóveis, especialista em imóveis de luxo em Brasília com mais de 15 anos de experiência. CRECI-DF, atendimento personalizado e resultados comprovados." 
        />
        <meta property="og:title" content="Quem Somos - CasaDF Imóveis | Corretor de Imóveis de Luxo" />
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <img
                  ...
                  alt="CasaDF Imóveis - Corretor de Imóveis de Luxo"
