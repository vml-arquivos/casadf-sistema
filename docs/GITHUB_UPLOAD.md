...
Este guia fornece instruções passo a passo para fazer upload do projeto **CasaDF** para o GitHub.
...
4. Preencha os dados:
   ...
   - **Description:** "Site profissional de imóveis de luxo em Brasília - CasaDF"
